...
parser.add_argument('--project_dir', default='D:/eeg-things数据集/', type=str)
...
epoched_test, _, ch_names, times = epoching(args, 'test', seed)#4个session 200x20x63x250 200张图片重复出现了20次
